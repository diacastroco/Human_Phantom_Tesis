...
void G4FemaleBuilder::BuildFetus(const G4String& colourName, G4bool solidVis, G4bool sensitivity )

{
  if (trunkVolume == 0)
    G4Exception("G4FemaleBuilder::BuildFetus()", "human_phantom0006", FatalException, "The trunk volume is missing !!!!!");
